...
Page({
  data: {
    ...
    api: [
      { iconurl: '/images/icon/wx_app_me.png', title: '用户登录', tap: 'userLogin' },
      { iconurl: '/images/icon/wx_app_form.png', title: '表单提交', tap: 'fromSubmit' },
  ...
  // 模拟开发者服务器获取openid和session_key，实现开发此代码是放在开发者服务器的，小程序端不需要此代码
  userLogin: function (event) {
    wx.login({
      success: function (res) {
        ...
        if (res.code) {
          wx.request({
            url: "https://api.weixin.qq.com/sns/jscode2session?appid=wx21e00a6be3012cb0&secret=8b992471d92a115e89175bacf79c9045&js_code=" + res.code + "&grant_type=authorization_code",
            success: function (res) {
              console.log(res)
              wx.showToast({
                title: "用户登录成功",
